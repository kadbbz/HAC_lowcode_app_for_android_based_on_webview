...
(function(){
    ...
    HAC.__HAC_ENCODING_PREFIX="HACe_P!v1|";
    HAC.HAC_NULL_MASK="HACm_nUll";

    HAC.__HAC_decode = function(value){
        if(value === HAC.HAC_NULL_MASK){
            return null;
        }
        else if(value.indexOf(HAC.__HAC_ENCODING_PREFIX) <0){
            return value;
        }else{
            var input = value.substring(HAC.__HAC_ENCODING_PREFIX.length);
    ...
    HAC.dispatchSuccessCallback = function(ticket, payload, payload2){
        payload = HAC.__HAC_decode(payload);
        payload2 = HAC.__HAC_decode(payload2);
