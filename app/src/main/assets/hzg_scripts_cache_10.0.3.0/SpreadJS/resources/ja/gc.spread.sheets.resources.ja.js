...
exports.TOOLTIP_VALUE_POINT = ".value}\" \u8981\u7d20 \"{";
exports.TOOLTIP_SIZE = "\u30b5\u30a4\u30ba: ";
exports.TOOLTIP_VALUE = "\u5024: ";
exports.SERIES = "\u7cfb\u5217";
exports.INCREASE = "\u5897\u52a0";
exports.DECREASE = "\u6e1b\u5c11";
exports.TOTAL = "\u5408\u8a08";
...
exports.reportSheetAddRecord = 'Add Record';
exports.reportSheetDeleteRecord = 'Delete Record';
exports.reportSheetSubmit = 'Submit';
exports.reportSheetResetCellValue = 'Reset Current Cell';
...
exports.resource = {
    ...
    _builtInFunctionsResource: {
        ...
        'R.INDEX': functionDescription('(ReportSheet Specific) Returns the index of the specified cell in the parent measured extension.', [
            parameterDescription('reference'),
            parameterDescription('[context_reference]'),
        ]),
        'R.RANK': functionDescription('(ReportSheet Specific) Returns the rank of the specified cell in the parent node.', [
            parameterDescription('reference'),
            parameterDescription('[context_reference]'),
            parameterDescription('[order]'),
            parameterDescription('[rank_mode]'),
        ]),
        'SJS.FISCALYEAR': functionDescription('return fiscal year.', [
            parameterDescription('date'),
            parameterDescription('[start_month]'),
        ]),
        'R.R': functionDescription('(ReportSheet Specific) Relative offset according to the specified cell.', [
            parameterDescription('reference'),
            parameterDescription('offset'),
        ]),
        'R.A': functionDescription('(ReportSheet Specific) Absolute offset based on the specified cell.', [
            parameterDescription('reference'),
            parameterDescription('offset'),
        ]),
        'R.V': functionDescription('(ReportSheet Specific) Returns the data in the cell after the coordinate shift.', [
            parameterDescription('reference'),
            parameterDescription('[offset]', true),
        ]),
        'R.CURRENTPAGE': functionDescription('(ReportSheet Specific) Returns the current page as the first page in the report.', []),
        'R.PAGESCOUNT': functionDescription('(ReportSheet Specific) Returns the total number of current reports.', []),
        'R.PROPORTION': functionDescription('(ReportSheet Specific) Returns the percentage of the specified cell in its parent node.', [
            parameterDescription('value_reference'),
            parameterDescription('[context_reference1]'),
            parameterDescription('[context_reference2]'),
        ]),
        'R.CUMULATIVE': functionDescription('(ReportSheet Specific) Returns the accumulated value of the current cell.', [
            parameterDescription('value_reference'),
            parameterDescription('[context_reference1]'),
            parameterDescription('[context_reference2]'),
        ]),
        'R.MOM': functionDescription('(ReportSheet Specific) Returns the ring data of the target cell.', [
            parameterDescription('value_reference'),
            parameterDescription('[context_reference1]'),
            parameterDescription('[context_reference2]'),
        ]),
        'R.YOY': functionDescription('(ReportSheet Specific) Returns the year-on-year data of the target cell.', [
            parameterDescription('value_reference'),
            parameterDescription('context_reference1'),
            parameterDescription('[context_reference2]'),
        ]),
    ...
    _tableFunctionsResource: {
 	...
 	function __nested_webpack_require_209860__(moduleId) {
 		...
 		__webpack_modules__[moduleId](module, module.exports, __nested_webpack_require_209860__);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SR = void 0;
var calcEngine_res_ja_1 = __nested_webpack_require_209860__( "./src/calcEngine.res.ja.ts");
...
/******/ })()
;
//# sourceMappingURL=gc.spread.sheets.resources.ja.17.0.5.js.map
}));